...
<body>
  ...
  <div class="wrap-header">
                   <header>                                
                   <a href="index.php"><img height="92" src="/VirtualPlanet/images/Logo.jpg" width="93" />
  ...
  <span><?php if(isset($_COOKIE['c_name'])){  
    ...
    print "Hello " . $cookie . " Welcome Back &nbsp;<a href='http://lmason09.com/Virtual_Planet/puls/change.php'>Change Password</a>" . " If you are not " . $cookie . " then sign out here" . " <a href='http://lmason09.com/Virtual_Planet/puls/logout.php'>Sign Out<a/> ";
}
else{
    print "Welcome Guest." . "<a href='http://lmason09.com/Virtual_Planet/puls/index.php'>Please sign in here<a/>";
    // ### check login start ###
//session_start();
...
<!-- Products List Start -->
<?php
$results = $mysqli->query("SELECT product_code, category, product_name, product_desc, platform, available, product_img_name, price FROM products WHERE platform=\"Xbox One\" ORDER BY id ASC");
if($results){ 
