...
<body>
  ...
  <div class="wrap-header">
                   <header>                                
                   <a href="index.php"><img height="92" src="/Virtual_Planet/images/Logo.jpg" width="93" />
...
<!-- Products List Start -->
<?php
$results = $mysqli->query("SELECT product_code, category, product_name, product_desc, platform, available, product_img_name, price FROM products WHERE platform=\"PC\" ORDER BY id ASC");
if($results){ 
