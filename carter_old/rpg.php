...
<body>
  ...
  <span><?php if(isset($_COOKIE['c_name'])){  
    ...
    print "Hello " . $cookie . " Welcome Back &nbsp;<a href='http://lmason09.com/Web231/Virtual_Planet/puls/change.php'>Change Password</a>" . " If you are not " . $cookie . " then sign out here" . " <a href='http://lmason09.com/Virtual_Planet/puls/logout.php'>Sign Out<a/> ";
}
else{
