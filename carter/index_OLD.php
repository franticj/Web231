...
<header id="header">
<div class="logo>
<object id="FlashID" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="200" height="100">
    ...
    <!--[if !IE]>-->
    <object type="application/x-shockwave-flash" data="images/Planet Logo.swf" width="400" height="150">
      <!--<![endif]-->
      <param name="quality" value="high">
      <param name="wmode" value="opaque">
      <param name="swfversion" value="30.0.0.0">
      ...
      <div>
        ...
        <p><a href="http://www.adobe.com/go/getflashplayer"><img src="http://www.adobe.com/images/shared/download_buttons/get_flash_player.gif" alt="Get Adobe Flash player" width="400" height="150" /></a></p>
      </div>
      <!--[if !IE]>-->
    </object>
    <!--<![endif]-->
