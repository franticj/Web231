...
/*
<form name="register" action="<(questionmark)php print htmlentities($_SERVER['PHP_SELF']); (questionmark)>" method="post" onsubmit="javascript:doRegister(this);">
...
function writeJS(){
var str='';
str+='	<form name="register" action="<?php print htmlentities($_SERVER['PHP_SELF']); ?>" method="post" onsubmit="javascript:doRegister(this);">';
